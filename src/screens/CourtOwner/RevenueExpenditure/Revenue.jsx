    ...
    <View style={{ flex: 1, backgroundColor: COLORS.white }}>
      ...
      <View style={styles.container}>
        ...
        >
          ...
          <View style={styles.textItem}>
            <Text style={styles.semiboldText}>{formatDate(chosenDate)}</Text>
            <View
              style={{ flexDirection: "row", alignItems: "center", gap: 5 }}
            >
              <View style={styles.dot}></View>
              <Text
                style={[styles.semiboldText, { color: COLORS.darkGreenText }]}
              >
                3 lượt đặt
              </Text>
            </View>
            ...
            renderItem={({ item, index }) => {
              return (
                <View style={styles.item}>
                  ...
                  {item.slotDetail.map((court, index) => {
                    return (
                      <View key={index} style={styles.bookedSlot}>
                        ...
                        >
                          <Divider orientation={"vertical"} color={"#CECECE"} />
                          <ChipList
                            isHorizontal={false}
                  ...
                  >
                    <View style={styles.bookedInfo}>
                      <Text styles={[styles.mediumText]}>Số tiền:</Text>
